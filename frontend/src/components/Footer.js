...
const Footer = () => {
  ...
  return (
    <MDBFooter className="font-small footer pt-4 mt-4">
      ...
      <h5>Made with <i className="fa fa-heart" style={{color:"#D2042D"}}></i> by Vignesh</h5>
      <hr/>
        <MDBRow >
          <MDBCol md="2">
          ...
          <MDBCol md="2">
          <a className="decorat" href="https://www.facebook.com/profile.php?id=100013611492947">Facebook</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="https://www.instagram.com/vignesh_7787/">Instagram</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="https://www.linkedin.com/in/vignesh-shivan-7b0480210/">LinkedIn</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="https://github.com/vignesh442002">Github</a>
          </MDBCol>
          <MDBCol md="2">
          <a className="decorat" href="mailto:vicky442001@gamil.com">Mail Us</a>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
